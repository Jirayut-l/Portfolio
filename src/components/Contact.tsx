        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-secondary/50 rounded-3xl p-8 md:p-12 border border-border">
            <form className="space-y-6">
              <div>
                <label className="block text-sm font-bold mb-2 uppercase tracking-wider text-foreground/50">Full Name</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-sm font-bold mb-2 uppercase tracking-wider text-foreground/50">Email Address</label>
                <input 
                  type="email" 
                  className="w-full bg-background border border-border rounded-xl px-4 py-4 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-foreground"
              ...
              <div>
                <label className="block text-sm font-bold mb-2 uppercase tracking-wider text-foreground/50">Message</label>
                <textarea 
                  rows={4}
                  className="w-full bg-background border border-border rounded-xl px-4 py-4 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-foreground"
              ...
              <button className="w-full py-4 rounded-xl bg-primary text-primary-foreground font-bold hover:bg-accent transition-all shadow-lg shadow-primary/20">
                Send Message
              </button>
            </form>
          </div>
